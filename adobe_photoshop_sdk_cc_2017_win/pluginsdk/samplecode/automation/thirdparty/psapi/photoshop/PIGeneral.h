...
* If a plug-in needs to examine the elements of another plug-inï¿½s PiPL for some reason or 
...
* Code descriptors tell Photoshop the type and location of a plug-inï¿½s code. More 
...
* in Photoshopï¿½s menus based on the current documentï¿½s image mode.
*/
...
/**	 
*A unique string (UUID or your own TM/ï¿? string) that differentiates one 
...
{
	Fixed gamma;	  /**< The monitorï¿½s gamma value or zero if the whole record is invalid. */
	Fixed redX;		  /**< The chromaticity coordinates of the monitorï¿½s phosphors */
	Fixed redY;		  /**< The chromaticity coordinates of the monitorï¿½s phosphors */
	Fixed greenX;	  /**< The chromaticity coordinates of the monitorï¿½s phosphors */
	Fixed greenY;	  /**< The chromaticity coordinates of the monitorï¿½s phosphors */
	Fixed blueX;	  /**< The chromaticity coordinates of the monitorï¿½s phosphors */
	Fixed blueY;	  /**< The chromaticity coordinates of the monitorï¿½s phosphors */
	Fixed whiteX;	  /**< The chromaticity coordinates of the monitorï¿½s white point. */
	Fixed whiteY;	  /**< The chromaticity coordinates of the monitorï¿½s white point. */
...
*/
	...
	* verify the host signature (in the parameter blockï¿½s \c hostSig field) before 
	...
	* Each repeated call must go through your plug-inï¿½s \c main() entry point. With \c AdvanceStateProc, a plug-in 
	...
	* -	choose a color using the userï¿½s preferred color picker 
...
*/
	...
	* down for the plug-inï¿½s benefit, such as the continue calls to Filter and Export plug-ins.
	*/
...
*/
	...
	* coordinates donï¿½t "fall through the cracks." 
	...
	* switching between point sampling and linear interpolation. If Photoshop didnï¿½t do this, 
	* a plug-in could end up modifying pixels using point sampling that wouldnï¿½t get modified 
...
*/
	...
	* the bounds of the port, they wonï¿½t be written.
