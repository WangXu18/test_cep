...
set PhotoshopSDKRoot=C:\Users\Kingsoft\Desktop\adobe_photoshop_sdk_cc_2017_win\pluginsdk
set CnvtPiPLExePath="%PhotoshopSDKRoot%\samplecode\resources\Cnvtpipl.exe"
set PhotoshopPluginsDeployPath=%~dp0deploy

set ZXPSignCmdExe=C:\Users\Kingsoft\Desktop\ZXPSignCmd.exe
set ZXPCert=‪C:\Users\Kingsoft\Desktop\automation.p12
set ZXPCertPassword=password123456
