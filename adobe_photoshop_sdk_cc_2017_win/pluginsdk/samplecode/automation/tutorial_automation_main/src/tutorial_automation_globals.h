...
#define TUTORIAL_AUTOMATION_PLUGINNAME "test_auto"
...
#define EXPORT_LAYERS_CSXS_EVENT_ID "liebao.browser.aet.exportlayersevent"
#define DONE_CSXS_EVENT_ID "liebao.browser.aet.doneevent"