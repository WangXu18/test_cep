...
* If a plug-in needs to examine the elements of another plug-in抯 PiPL for some reason or 
...
* Code descriptors tell Photoshop the type and location of a plug-in抯 code. More 
...
* in Photoshop抯 menus based on the current document抯 image mode.
*/
...
{
	Fixed gamma;	  /**< The monitor抯 gamma value or zero if the whole record is invalid. */
	Fixed redX;		  /**< The chromaticity coordinates of the monitor抯 phosphors */
	Fixed redY;		  /**< The chromaticity coordinates of the monitor抯 phosphors */
	Fixed greenX;	  /**< The chromaticity coordinates of the monitor抯 phosphors */
	Fixed greenY;	  /**< The chromaticity coordinates of the monitor抯 phosphors */
	Fixed blueX;	  /**< The chromaticity coordinates of the monitor抯 phosphors */
	Fixed blueY;	  /**< The chromaticity coordinates of the monitor抯 phosphors */
	Fixed whiteX;	  /**< The chromaticity coordinates of the monitor抯 white point. */
	Fixed whiteY;	  /**< The chromaticity coordinates of the monitor抯 white point. */
...
*/
	...
	* verify the host signature (in the parameter block抯 \c hostSig field) before 
	...
	* Each repeated call must go through your plug-in抯 \c main() entry point. With \c AdvanceStateProc, a plug-in 
	...
	* -	choose a color using the user抯 preferred color picker 
...
*/
	...
	* down for the plug-in抯 benefit, such as the continue calls to Filter and Export plug-ins.
	*/
...
*/
	...
	* coordinates don抰 "fall through the cracks." 
	...
	* switching between point sampling and linear interpolation. If Photoshop didn抰 do this, 
	* a plug-in could end up modifying pixels using point sampling that wouldn抰 get modified 
...
*/
	...
	* the bounds of the port, they won抰 be written.
